...
// This done so that the asset can be attached to the main website easily
// I have imported and exported it
// for example we can use assets.logo and it will display it
export const assets = {
    logo,
    hero_img,
    cart_icon,
...
//Here is an array representing product with its keys
//here also we added export so that we can use it in any other component
